...
const UnifiedSearch = () => {
  ...
  const [sampleTxt, setSampleTxt] = useState(
    "Company A sues Company B for breach of contract, claiming Rs 500,000 in damages for failure to deliver goods as per the agreement. Company B argues that the delay was due to unforeseen shipping disruptions and is not liable for the damages."
  );
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="mb-6 space-y-4">
            ...
            <div className="flex justify-end">
              <button
                onClick={() => setQuery(sampleTxt)}
                className={`bg-gradient-to-r from-green-400 via-green-500 to-green-600 text-white py-2 px-6 rounded-lg hover:from-purple-500 hover:to-green-700 transition duration-200 shadow-md mx-12
                `}
              >
                Sample Text
              </button>
