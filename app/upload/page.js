                    ...
                    <div className="w-full flex items-center justify-center gap-4">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="absolute opacity-0 w-full h-full z-50 cursor-pointer"
                            />
                            <div
                                className="bg-gradient-to-r from-purple-400 via-blue-500 to-blue-600 text-white py-3 px-8 rounded-lg shadow-md text-center relative z-10 cursor-pointer hover:from-purple-500 hover:to-blue-700 transition duration-200"
